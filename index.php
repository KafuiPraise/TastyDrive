...
<style>
  header.masthead {
    background: url(./user/assets/img<?php echo $_SESSION['setting_cover_img'] ?>);
...
<body id="page-top">
  ...
  <footer class="bg-light py-5">
    <div class="container">
      <div class="small text-center text-muted">Copyright © 2024 | <a href="https://github.com/KafuiPraise/TastyDrive/" target="_blank">TastyDrive</a></div>
    </div>
  </footer>
