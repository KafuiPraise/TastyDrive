 <!-- Masthead-->
        ...
        <div id="menu-field" class="card-deck">
                ...
                <div class="col-lg-3">
                    <div class="card menu-item">
                        <img src="./user/assets/img/<?php echo $row['img_path'] ?>" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title"><?php echo $row['name'] ?></h5>
                            <p class="card-text truncate"><?php echo $row['description'] ?></p>
                            <p class="card-text"><?php echo "GH₵" . number_format($row['price'], 2) ?></p>
    ...
    <script>
        ...
        $('.view_prod').click(function(){
            uni_modal_right('Product','./user/view_prod.php?id='+$(this).attr('data-id'))
        })
    </script>
